...
bp.add_url_rule("/course-add/", view_func=bp.course_add,
                methods=["GET", "POST"])
bp.add_url_rule("/course-delete/<string:number>",
                view_func=bp.course_delete, methods=["GET", "POST"])
bp.add_url_rule("/course-correct/<string:number>",
                view_func=bp.course_correct, methods=["GET", "POST"])
